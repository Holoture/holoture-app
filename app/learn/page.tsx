...
const ARTICLES: Article[] = [
  ...
  // ── INTERMEDIATE ──────────────────────────────────────────────────────────────
  {
    ...
    readTime: '4 min',
    summary: 'Momentum signals target stocks with strong recent price acceleration. They have a different risk profile from swing and long-term signals — here is what you need to know.',
    sections: [
      {
        heading: 'What Is Momentum?',
        body: 'Momentum refers to a stock\'s tendency to continue moving in the same direction once it has started. A stock that has risen 15% in the past two weeks and is breaking out to new highs with rising volume is showing strong momentum. Momentum signals capitalize on this continuation bias.',
      },
      {
        heading: 'Why Momentum Works',
        body: 'Institutional investors (funds, banks) cannot buy or sell large positions instantly — they must accumulate or distribute shares over days and weeks. This creates directional pressure that persists long enough for momentum signals to capture meaningful moves.',
      },
      {
        heading: 'The Risks of Momentum',
        body: 'Momentum can reverse sharply and without warning. A stock up 30% on momentum can give back half that gain in a single session if sentiment shifts. Key risks:',
        bullets: [
          'Late entries (chasing after a big move) are high-risk',
          'Stops need to be tighter than on swing signals — momentum names move fast',
          'Pro members get up to 5 momentum signals daily; Max gets unlimited',
          'Use the confidence score heavily — only act on 75%+ confidence momentum signals',
        ],
      },
      {
        heading: 'Entry Timing for Momentum',
        body: 'The ideal momentum entry is on a brief pullback to support after an initial breakout — not directly into the breakout candle. Patience here dramatically improves risk/reward. If a momentum signal has already run 10%+ from the entry zone, the risk/reward has deteriorated.',
      },
    ],
    takeaways: [
      'Momentum signals target continuation of existing strong moves — not reversals',
      'They have higher short-term win rates but can reverse violently',
      'Only act on momentum signals with 75%+ confidence',
      'Enter on pullbacks, not into extended breakouts — entry price matters enormously',
    ],
  },
  {
