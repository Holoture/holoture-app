        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-lg" style={{ color: '#94a3b8' }}>
              Stop guessing. Start trading with AI-backed conviction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="mt-3 mb-6">
                ...
                <span className="ml-1" style={{ color: '#94a3b8' }}>/month</span>
              </div>
      ...
      <footer style={{ borderTop: '1px solid #4a4a4a', backgroundColor: '#404040' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm" style={{ color: '#94a3b8' }}>
            © {new Date().getFullYear()} Holoture. Not financial advice.
          </p>
        </div>
      </footer>
    </div>
