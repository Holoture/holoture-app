...
// reversal of this feature's original design. Signal rows with
// catalystType != null. As of cron/catalyst-signals/route.ts, some of
// these bypass the liquidity floor entirely (thin/illiquid names are
// admissible there) — NOT "same liquidity floor as every other signal"
// anymore. cron/signals' own catalyst-tagged output (still floor-gated)
// is mixed in here too; there is currently no per-row way to tell which
// pipeline produced a given signal.
//
// Deliberately does NOT embed the separate News Catalyst Alerts feed
// (NewsCatalystAlert, GlobeNewswire-sourced) — tried that, reverted per
// explicit instruction: this page should not read as a clone of
// /catalyst-alerts. Signal-only.
        ...
        <div className="mb-8">
          ...
          >
            ...
            <p className="text-xs" style={{ color: 'var(--text-w60)' }}>
              Unvetted. Some signals below are NOT subject to the liquidity floor applied elsewhere on this platform — thin, illiquid names are admissible here. Not financial advice.
            </p>
          </div>
        </div>
